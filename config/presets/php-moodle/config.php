...
$CFG->dbhost    = $_ENV["DATABASE_PGSQL_HOST"];  // eg 'localhost' or 'db.isp.com' or IP
$CFG->dbname    = $_ENV["DATABASE_PGSQL_DATABASE"];     // database name, eg moodle
$CFG->dbuser    = $_ENV["DATABASE_PGSQL_USERNAME"];   // your database username
$CFG->dbpass    = $_ENV["DATABASE_PGSQL_PASSWORD"];   // your database password
...
$CFG->wwwroot   = $_ENV["WWW_ROOT_HTTPS"];
